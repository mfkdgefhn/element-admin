 ...
 * @LastEditors: anan
 * @LastEditTime: 2020-10-07 10:24:04
 */
export default {
  route: {
    ...
    vouWriteOff: 'Paso a pérdidas y ganancias de vales',
    example: 'Ejemplo',
  ...
  onlineUsers: {
    operationUser: 'Usuario operativo',
    queryAllOnline: 'Buscar en todos los foros',
    includingVisitorUsers: 'Usuarios de Turismo',
    search: 'Búsqueda',
    refresh: 'Actualizar'
  },
  example: {
