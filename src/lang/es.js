export default {
  route: {
    ...
    notice: 'Anuncios',
    log: 'Log',
    operationallog: 'Registro de Operaciones',
  ...
  roletable: {
    ...
    perChar: 'Carácter de autorización',
  ...
  menutable: {
    ...
    type: 'Tipo',
    show: 'Visible',
    perLdentification: 'Identificador de permisos',
    edit: 'Operación',
    addMenu: 'Adición',
    delete: 'Eliminar'
  },
  ...
  dictionarytable: {
    id: 'Número',
    dictionaryPrimaryKey: 'Clave primaria',
  ...
  parametersettingstable: {
    id: 'Número',
    parameterPrimaryKey: 'Clave primaria',
    parameterName: 'Nombre del parámetro',
    parameterKeyName: 'Nombre de parámetro',
    parameterKeyValue: 'Valor de parámetro',
    systemBuiltIn: 'Sistema interno',
    remarks: 'Observaciones',
    createDate: 'Tiempo de creación',
    edit: 'Operación',
    delete: 'Eliminar'
  ...
  operationallogtable: {
    ...
    systemMdule: 'Módulo del sistema',
    typeOfOperation: 'Tipo de operación',
    Operator: 'Operador M.',
    departmentName: 'Nombre del Departamento',
    Host: 'Servidor',
    operatingSite: 'Lugar de operación',
    operationalStatus: 'Estado de funcionamiento',
  ...
  loginlogtable: {
    ...
    logonName: 'Nombre del registro',
    loginAddress: 'Dirección de registro',
    locationOfLogin: 'Lugar de entrada',
    browser: 'Navegador',
    operatingSystem: 'Sistema operativo',
    loginStatus: 'Estado de entrada',
    operationalInformation: 'Información operativa',
    loginTime: 'Tiempo de entrada'
  },
  example: {
